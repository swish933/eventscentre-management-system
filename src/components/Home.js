			...
			<div className='home__about container-fluid p-4 my-3 text-center text-lg-left d-flex flex-wrap flex-lg-nowrap justify-content-between align-items-center'>
				<div className='info container-md'>
					<p>
						...
						with the idea of bringing people together, for business, celebration
						or the arts.
					</p>
					<p>
						Since our establishment, we have hosted countless events from
						Meetings & Conferences to Product launches to Screenings to Private
						Celebrations and has gained a reputation for its commitment to
						excellence, outstanding service and uncompromising quality. From
						sophisticated intimate celebrations to elegant affairs, we are
						dedicated to facilitating exceptional events.
					</p>
					<p>
						...
						places to host your events. We are very hardworking and always have
